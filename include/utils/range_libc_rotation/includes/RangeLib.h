...
#ifndef RANGE_LIB_ROTATION_H
#define RANGE_LIB_ROTATION_H

#include "utils/range_libc_rotation/vendor/lodepng/lodepng.h"
#include "utils/range_libc_rotation/vendor/distance_transform.h"
#include "utils/range_libc_rotation/includes/RangeUtils.h"
...
*/
        ...
        // NOTE: (floorf, ceilf)
        // Mean dt error  = 0.001317 rad
        // Mean error     = 0.003608 m

        // (floorf, floorf)
        // Mean dt error  = 0.000154 rad
        // Mean error     = 0.006203 m
...
namespace benchmark_rot {
	template <class range_T>
	class BenchmarkRot
	{
	public:
		BenchmarkRot(range_T rm) : range(rm) {
			map = range.getMap();
		};
		~BenchmarkRot() {};
		...
		ranges_rot::OMap *getMap() {return range.getMap(); }
