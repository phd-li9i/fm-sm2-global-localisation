...
title('Mean inlier pose error');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
s(1) = subplot(5,2,1);
hold on;
plot(xaxis, csm_corridor_pose_errors(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_corridor_pose_errors(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_corridor_pose_errors(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
...
s(2) = subplot(5,2,2);
hold on;
plot(xaxis, fmt_corridor_pose_errors(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_corridor_pose_errors(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_corridor_pose_errors(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
...
s(3) = subplot(5,2,3);
hold on;
plot(xaxis, csm_home_pose_errors(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_pose_errors(11,:), 'marker', '.', 'color',[c{11}(2,:)], 'linewidth', linewidth);
...
s(4) = subplot(5,2,4);
hold on;
plot(xaxis, fmt_home_pose_errors(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_pose_errors(11,:), 'marker', '.', 'color',[c{11}(2,:)], 'linewidth', linewidth);
...
s(5) = subplot(5,2,5);
hold on;
plot(xaxis, csm_warehouse_pose_errors(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_pose_errors(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_pose_errors(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_pose_errors(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_pose_errors(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_pose_errors(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_pose_errors(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);

xlim([0.5 3.5]);
set(gca, 'XTick', [1 2 3]);
set(gca, 'xticklabel', {'\\small $0.01$', '\\small $0.02$', '\\small $0.05$'});
set(gca, 'YTick', [3.14 3.26]);
set(gca, 'yticklabel', {'\\small $3.14$', '\\small $3.26$'});
set(gca,'xticklabel',[])
...
s(6) = subplot(5,2,6);
hold on;
plot(xaxis, fmt_warehouse_pose_errors(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_pose_errors(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_pose_errors(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_pose_errors(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_pose_errors(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_pose_errors(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_pose_errors(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
...
set(gca, 'yticklabel', {'\\small $0.04$', '\\small $0.06$', '\\small $0.08$', '\\small $0.10$', '\\small $0.12$', '\\small $0.14$', '\\small $0.16$'});
set(gca,'xticklabel',[])
box on;
...
s(7) = subplot(5,2,7);
hold on;
plot(xaxis, csm_willowgarage_pose_errors(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_pose_errors(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
...
set(gca, 'yticklabel', {'\\small $0.0$', '\\small $0.30$', '\\small $0.60$', '\\small $0.90$', '\\small $1.2$'});
set(gca,'xticklabel',[])
...
s(8) = subplot(5,2,8);
hold on;
plot(xaxis, fmt_willowgarage_pose_errors(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_pose_errors(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
...
s(9) = subplot(5,2,9);
hold on;
plot(xaxis, csm_landfill_pose_errors(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_pose_errors(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_pose_errors(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_pose_errors(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_pose_errors(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_pose_errors(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_pose_errors(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
...
s(10) = subplot(5,2,10);
hold on;
plot(xaxis, fmt_landfill_pose_errors(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_pose_errors(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_pose_errors(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_pose_errors(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_pose_errors(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_pose_errors(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_pose_errors(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
...
if (store_errors == 1)
  img_file = strcat(pwd, '/figures/simulations_pose_errors.eps');
