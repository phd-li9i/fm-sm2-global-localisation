...
title('Mean inlier pose error [m]');
%grid
box on
...
if (store)
  img_file = strcat('/home/li9i/catkin_ws/src/relief_fmt_global_localisation/experiments_logs/evaluation_scripts_phd/figures/csal_pose_errors.eps');
