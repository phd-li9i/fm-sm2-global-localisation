...
%for r=1:size(fmt_corridor_poses,1)
  ...
  %for c=1:size(fmt_corridor_poses{1},2)
    %[fmt_e fmt_oe fmt_t fmt_o] = function_top_level_script(fmt_corridor_poses{r}{c});
    %[csm_e csm_oe csm_t csm_o] = function_top_level_script(csm_corridor_poses{r}{c});
...
%for r=1:size(fmt_home_poses,1)
  ...
  %for c=1:size(fmt_home_poses{1},2)
    %[fmt_e fmt_oe fmt_t fmt_o] = function_top_level_script(fmt_home_poses{r}{c});
    %[csm_e csm_oe csm_t csm_o] = function_top_level_script(csm_home_poses{r}{c});
...
%for r=1:size(fmt_warehouse_poses,1)
  ...
  %for c=1:size(fmt_warehouse_poses{1},2)
    %[fmt_e fmt_oe fmt_t fmt_o] = function_top_level_script(fmt_warehouse_poses{r}{c});
    %[csm_e csm_oe csm_t csm_o] = function_top_level_script(csm_warehouse_poses{r}{c});
...
%for r=1:size(fmt_willowgarage_poses,1)
  ...
  %for c=1:size(fmt_willowgarage_poses{1},2)
    %[fmt_e fmt_oe fmt_t fmt_o] = function_top_level_script(fmt_willowgarage_poses{r}{c});
    %[csm_e csm_oe csm_t csm_o] = function_top_level_script(csm_willowgarage_poses{r}{c});
...
s(1) = subplot(5,2,1)
hold on;
plot(xaxis, csm_corridor_exec_time(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);,
plot(xaxis, csm_corridor_exec_time(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);,
plot(xaxis, csm_corridor_exec_time(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);,

xlim([0.5 3.5]);
ylim([0.16 0.32])
set(gca, 'XTick', [1 2 3]);
set(gca, 'xticklabel', {'\\small $0.01$', '\\small $0.02$', '\\small $0.05$'});
set(gca, 'YTick', [0.16 0.20 0.24 0.28 0.32]);
set(gca, 'yticklabel', {'\\small $160$', '\\small $200$', '\\small $240$', '\\small $280$', '\\small $320$'});
title('PL-ICP');
...
s(2) = subplot(5,2,2)
hold on;
plot(xaxis, fmt_corridor_exec_time(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);,
plot(xaxis, fmt_corridor_exec_time(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);,
plot(xaxis, fmt_corridor_exec_time(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);,
...
set(gca, 'xticklabel', {'\\small $0.01$', '\\small $0.02$', '\\small $0.05$'});
set(gca, 'YTick', [0.16 0.20 0.24 0.28 0.32]);
set(gca, 'yticklabel', {'\\small $160$', '\\small $200$', '\\small $240$', '\\small $208$', '\\small $320$'});
title('PGL-FMIC');
set(gca,'xticklabel',[])
box on;
...
s(3) = subplot(5,2,3)
hold on;
plot(xaxis, csm_home_exec_time(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_home_exec_time(11,:), 'marker', '.', 'color',[c{11}(2,:)], 'linewidth', linewidth);
...
set(gca, 'yticklabel', {'\\small $160$', '\\small $240$', '\\small $320$', '\\small $400$', '\\small $480$'});
...
s(4) = subplot(5,2,4)
hold on;
plot(xaxis, fmt_home_exec_time(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_home_exec_time(11,:), 'marker', '.', 'color',[c{11}(2,:)], 'linewidth', linewidth);
...
s(5) = subplot(5,2,5)
hold on;
plot(xaxis, csm_warehouse_exec_time(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_exec_time(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_exec_time(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_exec_time(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_exec_time(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_exec_time(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_warehouse_exec_time(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
...
set(gca, 'yticklabel', {'\\small $200$', '\\small $280$', '\\small $360$', '\\small $440$'});
...
s(6) = subplot(5,2,6)
hold on;
plot(xaxis, fmt_warehouse_exec_time(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_exec_time(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_exec_time(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_exec_time(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_exec_time(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_exec_time(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_warehouse_exec_time(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
...
s(7) = subplot(5,2,7)
hold on;
plot(xaxis, csm_willowgarage_exec_time(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_willowgarage_exec_time(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
...
set(gca, 'yticklabel', {'\\small $50$', '\\small $100$', '\\small $150$', '\\small $200$', '\\small $250$', '\\small $300$', '\\small $350$', '\\small $400$'});
set(gca,'xticklabel',[])
...
s(8) = subplot(5,2,8)
hold on;
plot(xaxis, fmt_willowgarage_exec_time(1,:), 'marker',  '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(2,:), 'marker',  '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(3,:), 'marker',  '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(4,:), 'marker',  '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(5,:), 'marker',  '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(6,:), 'marker',  '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(7,:), 'marker',  '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(8,:), 'marker',  '.', 'color', [c{8}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(9,:), 'marker',  '.', 'color', [c{9}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_willowgarage_exec_time(10,:), 'marker', '.', 'color',[c{10}(2,:)], 'linewidth', linewidth);
...
s(9) = subplot(5,2,9)
hold on;
plot(xaxis, csm_landfill_exec_time(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_exec_time(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_exec_time(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_exec_time(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_exec_time(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_exec_time(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, csm_landfill_exec_time(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
...
set(gca, 'yticklabel', {'\\small $200$', '\\small $250$', '\\small $300$', '\\small $350$'});
...
s(10) = subplot(5,2,10)
hold on;
plot(xaxis, fmt_landfill_exec_time(1,:), 'marker', '.', 'color', [c{1}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_exec_time(2,:), 'marker', '.', 'color', [c{2}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_exec_time(3,:), 'marker', '.', 'color', [c{3}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_exec_time(4,:), 'marker', '.', 'color', [c{4}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_exec_time(5,:), 'marker', '.', 'color', [c{5}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_exec_time(6,:), 'marker', '.', 'color', [c{6}(2,:)], 'linewidth', linewidth);
plot(xaxis, fmt_landfill_exec_time(7,:), 'marker', '.', 'color', [c{7}(2,:)], 'linewidth', linewidth);
...
if (store_errors == 1)
  img_file = strcat(pwd, '/figures/simulations_execution_times.eps');
