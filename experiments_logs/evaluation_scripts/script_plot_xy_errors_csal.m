...
subplot(2,1,1);
hold on
scatter(xaxis, fmt_csal_xy_errors, 20, 'k', 'o');
...
subplot(2,1,2);
hold on
scatter([1:7], csm_csal_xy_errors(1:7), 20,  'k', 's');
scatter([9], csm_csal_xy_errors(9), 20, 'k', 's');
scatter([11], csm_csal_xy_errors(11), 20, 'k', 's');
...
if (store_errors == 1)
  img_file = strcat('/media/ext/backup_files/AUTh/RELIEF/relief-fmt-global-localisation-paper/one_page/location_errors_csal.eps');
