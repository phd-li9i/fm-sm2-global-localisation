...
subplot(5,2,1)
hold on;
plot(xaxis, fmt_corridor_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, fmt_corridor_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, fmt_corridor_t_errors(3,:), 'marker', '*', 'color', 'k');
...
set(gca, 'yticklabel', {'$0.0$', '$0.002$','$0.004$','$0.006$','$0.008$','$0.010$','$0.012$'});
title('PGL-FMIC');
...
subplot(5,2,2)
hold on;
plot(xaxis, csm_corridor_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, csm_corridor_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, csm_corridor_t_errors(3,:), 'marker', '*', 'color', 'k');
...
subplot(5,2,3)
hold on;
plot(xaxis, fmt_home_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, fmt_home_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, fmt_home_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, fmt_home_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, fmt_home_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, fmt_home_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, fmt_home_t_errors(7,:), 'marker', 'd', 'color', 'k');
plot(xaxis, fmt_home_t_errors(8,:), 'marker', '^', 'color', 'k');
plot(xaxis, fmt_home_t_errors(9,:), 'marker', 'v', 'color', 'k');
plot(xaxis, fmt_home_t_errors(10,:), 'marker', '>', 'color', 'k');
plot(xaxis, fmt_home_t_errors(11,:), 'marker', '<', 'color', 'k');
...
set(gca, 'yticklabel', {'$0.0$', '$0.005$', '$0.01$', '$0.015$'});
set(gca, 'ylabel', 'HOME');
...
subplot(5,2,4)
hold on;
plot(xaxis, csm_home_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, csm_home_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, csm_home_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, csm_home_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, csm_home_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, csm_home_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, csm_home_t_errors(7,:), 'marker', 'd', 'color', 'k');
plot(xaxis, csm_home_t_errors(8,:), 'marker', '^', 'color', 'k');
plot(xaxis, csm_home_t_errors(9,:), 'marker', 'v', 'color', 'k');
plot(xaxis, csm_home_t_errors(10,:), 'marker', '>', 'color', 'k');
plot(xaxis, csm_home_t_errors(11,:), 'marker', '<', 'color', 'k');
...
subplot(5,2,5)
hold on;
plot(xaxis, fmt_warehouse_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, fmt_warehouse_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, fmt_warehouse_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, fmt_warehouse_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, fmt_warehouse_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, fmt_warehouse_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, fmt_warehouse_t_errors(7,:), 'marker', 'd', 'color', 'k');
...
set(gca, 'yticklabel', {'$0.0$', '$0.005$', '$0.010$', '$0.015$', '$0.020$'});
...
subplot(5,2,6)
hold on;
plot(xaxis, csm_warehouse_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, csm_warehouse_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, csm_warehouse_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, csm_warehouse_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, csm_warehouse_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, csm_warehouse_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, csm_warehouse_t_errors(7,:), 'marker', 'd', 'color', 'k');

xlim([0.5 3.5]);
set(gca, 'XTick', [1 2 3]);
set(gca, 'xticklabel', {'$0.01$', '$0.02$', '$0.05$'});
set(gca, 'YTick', [3.04 3.06 3.08 3.10 3.12 3.14 3.16]);
set(gca, 'yticklabel', {'$3.04$', '$3.06$', '$3.08$', '$3.10$', '$3.12$', '$3.14$', '$3.16$'});
...
subplot(5,2,7)
hold on;
plot(xaxis, fmt_willowgarage_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(7,:), 'marker', 'd', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(8,:), 'marker', '^', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(9,:), 'marker', 'v', 'color', 'k');
plot(xaxis, fmt_willowgarage_t_errors(10,:), 'marker', '>', 'color', 'k');
...
set(gca, 'yticklabel', {'$0.0$', '$0.02$', '$0.05$', '$0.10$', '$0.15$'});
...
subplot(5,2,8)
hold on;
plot(xaxis, csm_willowgarage_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(7,:), 'marker', 'd', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(8,:), 'marker', '^', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(9,:), 'marker', 'v', 'color', 'k');
plot(xaxis, csm_willowgarage_t_errors(10,:), 'marker', '>', 'color', 'k');
...
set(gca, 'yticklabel', {'$0.0$', '$0.50$', '$1.0$', '$1.2$'});
...
subplot(5,2,9)
hold on;
plot(xaxis, fmt_landfill_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, fmt_landfill_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, fmt_landfill_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, fmt_landfill_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, fmt_landfill_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, fmt_landfill_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, fmt_landfill_t_errors(7,:), 'marker', 'd', 'color', 'k');
...
set(gca, 'yticklabel', {'$0.0$', '$0.005$', '$0.010$', '$0.015$', '$0.020$', '$0.025$'});
set(gca, 'xlabel', '$d$ [m]: sensor noise $\mathcal{N}(0.0,d)$');
set(gca, 'ylabel', 'LANDFILL');

subplot(5,2,10)
hold on;
plot(xaxis, csm_landfill_t_errors(1,:), 'marker', '+', 'color', 'k');
plot(xaxis, csm_landfill_t_errors(2,:), 'marker', 'o', 'color', 'k');
plot(xaxis, csm_landfill_t_errors(3,:), 'marker', '*', 'color', 'k');
plot(xaxis, csm_landfill_t_errors(4,:), 'marker', '.', 'color', 'k');
plot(xaxis, csm_landfill_t_errors(5,:), 'marker', 'x', 'color', 'k');
plot(xaxis, csm_landfill_t_errors(6,:), 'marker', 's', 'color', 'k');
plot(xaxis, csm_landfill_t_errors(7,:), 'marker', 'd', 'color', 'k');
...
if (store_errors == 1)
  img_file = strcat('/media/ext/backup_files/AUTh/RELIEF/relief-fmt-global-localisation-paper/figures/results/simulation/orientation_errors.eps');
